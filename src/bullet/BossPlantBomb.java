 ...
 *
 */
public class BossPlantBomb extends Bullet{
	 ...
	 */
	public BossPlantBomb(Mobile owner, int xAxis, int yAxis) {
	...
	public BossPlantBomb(Mobile owner, int xAxis, int yAxis,int summon) {
		super(owner, xAxis, yAxis, 16);
		//set default dimensions
		setW(32);
		setH(32);
	 ...
	 */
	public BossPlantBomb(Mobile owner, int xAxis, int yAxis,int xOff, int yOff) {
		super(owner, xAxis, yAxis, 16);
	...
	{
		Sprite s = new Sprite(getLeft(), getTop(), getW(), getH(), 0, 0, 1, "PlantBomb");
		list.add(s);
	}
